...
public class MainController {
    ...
    public @ResponseBody String checkEquality(@RequestParam String urlBase, @RequestParam String[] urlArgs, @RequestParam String[] argValues, String name, String token) {
    ...
    public @ResponseBody String checkSubset(@RequestParam String urlBase, @RequestParam String[] values, @RequestParam String[] checkPath, String name, String token) {
        Object primaryTest;
    ...
    public @ResponseBody String checkDisjoint(@RequestParam String urlOne, @RequestParam String urlTwo, @RequestParam String[] checkPath, String name, String token) {
    ...
    public @ResponseBody String checkComplete(@RequestParam String urlBase, @RequestParam String[] values, @RequestParam String[] checkPath, String name, String token) {
    ...
    public @ResponseBody String checkDifference(@RequestParam String urlOne, @RequestParam String urlTwo, @RequestParam String[] checkPath, String name, String token) {
